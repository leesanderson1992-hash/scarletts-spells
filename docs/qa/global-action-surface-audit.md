...
| /analyse | [app/analyse/page.tsx](/Users/katiesanderson/Documents/Scarletts%20Spells/scarletts-spells/app/analyse/page.tsx:1) | intake links and save handoff | mixed | Submit manual writing intake and hand off to Review Work | link navigation and form submit | Create canonical writing-sample intake and open canonical review queue | Mixed links and form submit | Show save failures without losing typed writing | needs manual verification | mixed | no | yes | intake-only analysis compatibility pattern | yes | P1 |
