...
Task reward rule terminology should follow [docs/reward-system-contract.md](/Users/katiesanderson/Documents/Scarletts%20Spells/scarletts-spells/docs/reward-system-contract.md:1):
- Progress only
- Auto reward
...
Task completion semantics should defer to [docs/universal-progress-contract.md](/Users/katiesanderson/Documents/Scarletts%20Spells/scarletts-spells/docs/universal-progress-contract.md:1).
...
Implement the current phase from current-priorities.md using the structure in docs/modules-model.md and docs/course-task-mvp-plan.md.
