-- Reset one child back to a clean test-week state.
-- This clears:
-- - task completions
-- - task submissions / lesson submissions
-- - coin ledger events
-- - transfer requests
-- - spelling reward states and events
-- - daily spelling assignments
-- - practice attempts
-- - misspelling analysis history
-- - writing samples
--
-- It keeps:
-- - course definitions
...
begin
  ...
  -- Course work completion / submission history
  ...
  -- Spelling and analysis runtime history
...
select 'misspelling_instances' as table_name, count(*) as row_count
