...
This system is separate from the spelling queue.

The correct architecture is:

- course/task system manages learning structure
- spelling system manages spelling diagnosis, queue, practice, and review
- writing submissions from tasks can later feed into the spelling system
...
Submissions are important because they can later feed into the spelling system.
...
### Correct flow
course task writing -> submission saved -> Review work -> parent review -> spelling queue updated

### Incorrect flow
course task == spelling queue item
