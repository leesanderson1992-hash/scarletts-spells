...
assert(!renderer.includes("completeAdleLessonPartAction") && renderer.includes("CoverShutter") && renderer.includes("SentenceDictation") && renderer.includes("BaseWordCleaver") && renderer.includes("DefinitionWordBuilder"), "renderer uses canonical independent spelling, sentence dictation, and interactive morphology primitives without completion writes");
