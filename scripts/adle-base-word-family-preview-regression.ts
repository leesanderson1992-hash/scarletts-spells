...
assert(!renderer.includes("completeAdleLessonPartAction") && renderer.includes("CoverShutter") && renderer.includes("DiffReveal") && renderer.includes("BaseWordCleaver") && renderer.includes("DefinitionWordBuilder"), "renderer uses independent and interactive morphology primitives without completion writes");
