...
assert(sharedRouteMigration.includes("complete_adle_base_word_family_pilot_v1") && sharedRouteMigration.includes("adle_review_schedule_word_routes"), "V2 preserves V1 lesson safeguards and adds shared route linkage in the same transaction");
