...
const regressions = [
  ...
  "adle-generic-snapshot-v3-foundation-regression.ts",
  "adle-generic-snapshot-v3-writer-regression.ts",
  "adle-generic-snapshot-v3-d3-regression.ts",
  ...
  "adle-compound-word-structure-v2-regression.ts",
  "adle-compound-word-lesson-v2-regression.ts",
