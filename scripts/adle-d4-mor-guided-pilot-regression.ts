...
assert(soundSource.includes('"select"') && soundSource.includes("sharedContext") && splitSource.includes("✦ ✧ ✦"), "all interactions use the louder shared sound context and cleaver success has visual sparkles");
