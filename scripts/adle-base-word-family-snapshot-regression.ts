...
function word(id: string) { return { canonicalWordId: id, displayWord: id, wordSum: id, parts: [{ id: `${id}:base`, kind: "base", sourceText: id, surfaceText: id }], joins: [], transformationNotes: "reviewed", dictationSentence: `Please spell ${id}.`, dictationTargetTokenIndex: 2, audioText: `Please spell ${id}.` }; }
