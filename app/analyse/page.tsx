    ...
    >
      <section className="grid gap-4">
        <div className="brand-card rounded-3xl p-4 md:p-5">
          <p className="brand-eyebrow">Add Writing Sample</p>
          <h1 className="mt-1 text-2xl font-semibold tracking-tight text-[color:var(--ink)]">
            Paste paper-written work for later review
          </h1>
          <p className="mt-3 max-w-3xl text-sm leading-6 text-[color:var(--mid)]">
            Add writing completed outside the app here. This page only saves the
            sample and prepares it for the shared Writing Engine analysis path
            where supported. Parent review continues in Review Work.
          </p>
        ...
        <section className="brand-card rounded-3xl p-4 md:p-5">
          ...
          <form action={saveManualWritingSample} className="mt-4 grid gap-4">
            ...
            <div className="rounded-3xl border border-[var(--border)] bg-[rgba(255,247,220,0.28)] px-4 py-3 text-sm leading-6 text-[color:var(--mid)]">
              Saving this sample creates canonical writing-sample truth for the
              selected child. It does not review, verify, classify, or assign
