...
import { createDynamicSuffixStagingAssignmentAction } from "./actions";

export const dynamic = "force-dynamic";
export default async function DynamicSuffixStagingPage(props: { searchParams?: Promise<{ child?: string; mode?: string }> }) {
