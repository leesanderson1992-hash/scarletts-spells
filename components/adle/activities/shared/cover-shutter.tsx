...
export function CoverShutter(props: { word: string; splitPoints: number[]; components?: readonly string[]; initialState?: ShutterState; initialAttempt?: string; muted?: boolean; closePolicy?: CoverClosePolicy; onStateChange?: (state: ShutterState, attempt: string) => void; onComplete?: (attempt: string) => void }) {
