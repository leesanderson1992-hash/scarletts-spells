...
export const TO_V4_MANIFEST = Object.freeze({
  ...
  analyserVersion: "WHOLE_WRITING_CONTEXT_TO_SPACY_GATED_HYBRID_V4",
  ...
  fallbackEligibleReasons: [CONTEXT_V4_STRUCTURE_SOURCE.fallback.eligibleReasons.TO_GOVERNED_INFINITIVE_STRUCTURAL_AMBIGUITY],
  resourceLimits: CONTEXT_V4_STRUCTURE_SOURCE.limits,
  deploymentState: "DEVELOPMENT_CANDIDATE_DEFAULT_OFF" as const,
  sourceFingerprints: { ...CONTEXT_V4_SOURCE_PINS.shared, ...CONTEXT_V4_SOURCE_PINS.fallback, ...CONTEXT_V4_SOURCE_PINS.TO_TOO_TWO },
});
...
export function analyseToContextsV4Detailed(inputs: readonly ContextInputV4[]) {
  return analyseFamilyContextsV4WithFallback(TO_V4_MANIFEST, inputs);
}
