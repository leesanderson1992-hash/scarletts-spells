...
import {
  CONTEXT_V4_STRUCTURE_SOURCE, analyseFamilyContextsV4WithFallback, manifestFingerprintV4,
  type ContextInputV4,
...
export const THERE_V4_MANIFEST = Object.freeze({
  ...
  analyserVersion: "WHOLE_WRITING_CONTEXT_THERE_SPACY_GATED_HYBRID_V4",
  ...
  fallbackRuntimeIdentity: CONTEXT_V4_STRUCTURE_SOURCE.fallback.runtime,
  fallbackResourceLimits: CONTEXT_V4_STRUCTURE_SOURCE.fallback.limits,
  fallbackEligibleReasons: [CONTEXT_V4_STRUCTURE_SOURCE.fallback.eligibleReasons.THERE_CONTRACTION_STRUCTURAL_AMBIGUITY],
  resourceLimits: CONTEXT_V4_STRUCTURE_SOURCE.limits,
  deploymentState: "DEVELOPMENT_CANDIDATE_DEFAULT_OFF" as const,
  sourceFingerprints: { ...CONTEXT_V4_SOURCE_PINS.shared, ...CONTEXT_V4_SOURCE_PINS.fallback, ...CONTEXT_V4_SOURCE_PINS.THERE_THEIR_THEYRE },
});
...
export function analyseThereContextsV4Detailed(inputs: readonly ContextInputV4[]) {
  return analyseFamilyContextsV4WithFallback(THERE_V4_MANIFEST, inputs);
}
