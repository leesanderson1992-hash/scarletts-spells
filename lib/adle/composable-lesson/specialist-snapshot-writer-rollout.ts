...
export type SpecialistSnapshotV3WriterAuthorization = Readonly<{
  kind: "compound_word_v2_for_current_learner" | "dynamic_affix_v3_for_current_learner";
  childId: string;
}>;

export type SpecialistSnapshotV3RouteKey = "compound_word_lab:v2" | "dynamic_affix_word_lab:v3";
...
export function selectSpecialistSnapshotV3Writer(input: {
  ...
  const expectedMode = input.routeKey === "dynamic_affix_word_lab:v3"
